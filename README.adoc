...
`src/main/kotlin/com/example/blog/MonitorApplication.kt`
[source,kotlin]
----
...
Start the web application by running the `main` function of `MonitorApplication.kt`, and go to `http://localhost:8080/`, you should see a sober web page with a "Blog" headline.
...
`src/main/kotlin/com/example/blog/MonitorConfiguration.kt`
[source,kotlin]
----
@Configuration
...
`src/main/kotlin/com/example/blog/MonitorProperties.kt`
[source,kotlin]
----
@ConstructorBinding
